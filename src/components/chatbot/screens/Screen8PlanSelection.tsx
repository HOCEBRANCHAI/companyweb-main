  ...
  return <div className="space-y-4">
      <div className="flex items-center mb-2">
        ...
        <div className="flex-1 text-center">
          <h3 className="font-medium text-sm text-gray-900">Recommended Plan</h3>
        </div>
      </div>
      <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
        <div className="flex items-center justify-between mb-2">
          <h3 className="font-bold text-base text-gray-900">eBranch Plan</h3>
        ...
        <ul className="text-xs space-y-1 mb-3 text-gray-800">
        ...
        <div className="border-t border-gray-200 pt-2 mb-2">
          ...
          {countryFees.map((item, index) => <div key={index} className="flex justify-between text-xs text-gray-800">
              <span>{item.country} fees:</span>
              <span>€{item.fee}</span>
            </div>)}
          <div className="flex justify-between font-bold mt-2 text-sm text-gray-900">
            <span>Total:</span>
