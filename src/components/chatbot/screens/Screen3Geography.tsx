...
export const Screen3Geography: React.FC<Screen3Props> = ({
  ...
  return <div className="space-y-4">
      ...
      <div>
        ...
        <select value={basedIn} onChange={e => setBasedIn(e.target.value)} className="w-full p-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
