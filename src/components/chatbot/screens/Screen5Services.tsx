...
export const Screen5Services: React.FC<Screen5Props> = ({
  ...
  return <div className="space-y-4">
      ...
      {selectedServices.includes('Other') && <input type="text" value={otherService} onChange={e => setOtherService(e.target.value)} placeholder="Please specify other service" className="w-full p-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />}
